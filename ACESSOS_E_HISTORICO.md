...
## 11. Revisão antes do próximo deploy

Atualização registrada em 03/09/2026:

- Revisão geral de textos quebrados por acentuação nas telas principais.
- Correção de acentuação na tela de login.
...
- Corrigida a aba Relatórios para não exibir produtividade/departamentos de demonstração. Sem tarefas ou protocolos reais, os relatórios mostram estado vazio e contagens zeradas.
